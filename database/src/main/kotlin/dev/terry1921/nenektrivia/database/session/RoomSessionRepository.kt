...
class RoomSessionRepository(
    ...
    override suspend fun upsertSessionQuestion(ref: SessionQuestionCrossRef) =
        sessionQuestionDao.upsert(ref)

    override suspend fun correctCount(sessionId: String): Int =
        sessionQuestionDao.correctCount(sessionId)
}
